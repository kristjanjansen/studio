...
Streaming local camera

```
ffmpeg -f avfoundation -framerate 30 -video_size 1280x720 -i "0:0" -c:v libx264 -preset veryfast -b:v 2500k -maxrate 2500k -bufsize 5000k -c:a aac -b:a 128k -ar 44100 -f flv rtmps://live.cloudflare.com:443/live/0c5c311f472d6910b234146d98ba1beak7f9a35aa63f1b17357b29b3c303b639d
```
